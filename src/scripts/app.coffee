...
angular.module 'muradiyeWeb', [
  ...
  .config ($mdThemingProvider) ->
    $mdThemingProvider.definePalette 'muradiye', {'50':'#fdfeff','100':'#bddff1','200':'#8fc8e7','300':'#939598','400':'#3b9fd6','500':'#2a90c8','600':'#257eaf','700':'#1f6c95','800':'#1a597c','900':'#154763','A100':'#fdfeff','A200':'#bddff1','A400':'#3b9fd6','A700':'#1f6c95'}
